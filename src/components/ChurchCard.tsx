    ...
    <>
      ...
      <ModalSheetScroller draggableAt="top">
        <div className="pb-5">
          ...
          {/* Day selector — on dark bg, centered */}
          {dayKeys.length > 0 && (
          ...
          {/* White card — schedule text only */}
          {churchDetails && churchDetails.schedules.length > 0 && (
            <div className="mx-3 rounded-lg bg-white overflow-hidden">
              <p
                className={`px-4 py-3 whitespace-pre-line italic text-gray-500 ${!showAllInfo ? "line-clamp-6" : ""}`}
              ...
              <button
                ...
                className="w-full py-2 text-gray-400 transition-colors"
                style={{ fontSize: 11 }}
              >
                {showAllInfo
          ...
          <div className="flex items-center justify-center py-4">
            ...
            >
              <button className="flex items-center justify-center w-5 h-5">
                <svg className="w-5 h-5" viewBox="0 0 20 18" fill="white">
              ...
              <span className="tabular-nums text-white" style={{ fontSize: 16, fontWeight: 600 }}>
                {voteCount}
              </span>
              <div style={{ width: 1, height: 24, backgroundColor: "rgba(255,255,255,0.2)" }} />
              <button className="flex items-center justify-center w-5 h-5">
